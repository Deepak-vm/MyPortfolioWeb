...
function Footer() {
  return (
    <div className="bg-[#0d1219] px-8 md:px-16 lg:px-20 py-6 border-t border-cyan-500/20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <span>
              by <a href="https://github.com/deepak-vm" className="underline hover:text-cyan-400 transition-colors">Deepak</a>
            </span>
          </div>
        </div>
      </div>
